...
* Variable label: `Living alone`
* Variable description: `Participant lives alone`
...
c_label  <- c("not living alone"=0, "living alone"=1, "Missing"=999, "Do not know"=998, "Refuse"=997, "Not attempt not done"=996, "Does not answer"=995,  "Not applicable"=994, "Disable to measure"=993, "Impute"=992, "CAPI interviewer error"=991)
m_label <- c("not living alone"=0, "living alone"=1)
```
...
```{r f12, echo=FALSE}
sds <- ubcosG1W2[ , c("athlosid", "living_alone1970")]
...
hds <- tibble(id=sds[[1]], living_alone=sds[[2]])
```
...
```{r f14, echo=FALSE}
sds <- ubcosG1W4[ , c("athlosid", "living_alone_approx1990")]
sds[[2]] <- labelled(sds[[2]], labels = c_label)
...
```{r f15, echo=FALSE}
sds <- ubcosG1W5[ , c("athlosid", "living_alone_approx2000")]
sds[[2]] <- labelled(sds[[2]], labels = c_label)
...
```{r f16, echo=FALSE}
sds <- ubcosG1W6[ , c("athlosid", "living_alone_approx2008")]
sds[[2]] <- labelled(sds[[2]], labels = c_label)
...
```{r f22, echo=FALSE}
sds <- ubcosG2W2[ , c("athlosid", "living_alone1970")]
sds[[2]] <- labelled(sds[[2]], labels = c_label)
...
```{r f24, echo=FALSE}
sds <- ubcosG2W4[ , c("athlosid", "living_alone_approx1990")]
sds[[2]] <- labelled(sds[[2]], labels = c_label)
...
```{r f25, echo=FALSE}
sds <- ubcosG2W5[ , c("athlosid", "living_alone_approx2000")]
sds[[2]] <- labelled(sds[[2]], labels = c_label)
...
```{r f26, echo=FALSE}
sds <- ubcosG2W6[ , c("athlosid", "living_alone_approx2008")]
sds[[2]] <- labelled(sds[[2]], labels = c_label)
...
The validation consists of checking just the most frequent trajectories of living_alone.

**R script**
```{r vv}
# For 1st generation:
list_df <- list(tibble(id= UBCoS_m_g1_w2$id, living_alone2=UBCoS_m_g1_w2$living_alone),
                tibble(id= UBCoS_m_g1_w4$id, living_alone4=UBCoS_m_g1_w4$living_alone),
                tibble(id= UBCoS_m_g1_w5$id, living_alone5=UBCoS_m_g1_w5$living_alone), 
                tibble(id= UBCoS_m_g1_w6$id, living_alone6=UBCoS_m_g1_w6$living_alone))
...
v.ndf <- with(new.df, paste(living_alone2, living_alone4, living_alone5, living_alone6,sep=""))
ff <- frq(v.ndf)[[1]][,c(1,2,4)]
ff <- ff[ff[,3]>=0.3,]
kable(ff[order(-ff$frq),])

# For 2nd generation:**
list_df <- list(tibble(id= UBCoS_m_g2_w2$id, living_alone2=UBCoS_m_g2_w2$living_alone),
                tibble(id= UBCoS_m_g2_w4$id, living_alone4=UBCoS_m_g2_w4$living_alone),
                tibble(id= UBCoS_m_g2_w5$id, living_alone5=UBCoS_m_g2_w5$living_alone), 
                tibble(id= UBCoS_m_g2_w6$id, living_alone6=UBCoS_m_g2_w6$living_alone))
