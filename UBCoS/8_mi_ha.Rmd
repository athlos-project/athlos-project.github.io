...
Two variables are created: `mi_ha`and `mi_ha_age`:

* Short name: `mi_ha`
* Variable label: `Myocardial infarction or heart attack`
* Variable description: `First episode of myocardial infarction or heart attack in the last observed period of time.`
* Domain: `Diseases`
...
* Variable label: `Age of myocardial infarction or heart attack`
* Variable description: `Age of first episode of myocardial infarction or heart attack in the last observed period of time.`
* Domain: `Diseases`
...
ds_label_a <- "Age of myocardial infarction or heart attack"
...
* Description: `First diagnosis of mi_ha before the 1st November 1970`

```{r f121, echo=FALSE}
sds <- ubcosG1W2[c("athlosid", "mi_ha_firstdate1970", "mi_ha_firstage1970", "mi_ha1970")]
...
* Name: `mi_ha_firstage1970`
* Table name: `ubcosG1W2`
* Label: `Age of first diagnosis of mi_ha before the 1st November 1970`
* Description: 
...
For the variable `mi_ha`, value 0 is assigned when date of first diagnosis of mi_ha is later than 1st November 1970, the approximate date of the census registry, or never, and value 1 when prior to that date. 

**R script:**
```{r h121}
# 'sds': study dataset
# 'hds': harmonised dataset
hds <- tibble(id=sds[[1]], mi_ha=sds[[4]])
```

For the variable `mi_ha_age`, the same age is assigned when the first diagnosis of mi_ha is before than 1st November 1970, otherwise the value 994 (not applicable) is assigned.
...
* Description: `First diagnosis of mi_ha before the 15th September 1980`

```{r f131, echo=FALSE}
sds <- ubcosG1W3[c("athlosid", "mi_ha_firstdate1980", "mi_ha_firstage1980", "mi_ha1980")]
...
* Name: `mi_ha_firstage1980`
* Table name: `ubcosG1W3`
* Label: `Age of first diagnosis of mi_ha before the 15th September 1980`
* Description: 
...
For the variable `mi_ha`, value 0 is assigned when date of first diagnosis of mi_ha is later than 15th September 1980, the approximate date of the census registry, or never, and value 1 when prior to that date. 
...
For the variable `mi_ha_age`, the same age is assigned when the first diagnosis of mi_ha is before than 15th September 1980, otherwise the value 994 (not applicable) is assigned.
...
* Description: `First diagnosis of mi_ha before the 1st November 1990`

```{r f141, echo=FALSE}
sds <- ubcosG1W4[c("athlosid", "mi_ha_firstdate1990", "mi_ha_firstage1990", "mi_ha1990")]
...
* Name: `mi_ha_firstage1990`
* Table name: `ubcosG1W4`
* Label: `Age of first diagnosis of mi_ha before the 1st November 1990`
* Description: 
...
For the variable `mi_ha`, value 0 is assigned when date of first diagnosis of mi_ha is later than 1st November 1990, the approximate date of the census registry, or never, and value 1 when prior to that date. 
...
For the variable `mi_ha_age`, the same age is assigned when the first diagnosis of mi_ha is before than 1st November 1990, otherwise the value 994 (not applicable) is assigned.
...
* Description: `First diagnosis of mi_ha before the 1st November 2000`

```{r f151, echo=FALSE}
sds <- ubcosG1W5[c("athlosid", "mi_ha_firstdate2000", "mi_ha_firstage2000", "mi_ha2000")]
...
* Name: `mi_ha_firstage2000`
* Table name: `ubcosG1W5`
* Label: `Age of first diagnosis of mi_ha before the 1st November 2000`
* Description: 
...
For the variable `mi_ha`, value 0 is assigned when date of first diagnosis of mi_ha is later than 1st November 2000, the approximate date of the census registry, or never, and value 1 when prior to that date. 
...
For the variable `mi_ha_age`, the same age is assigned when the first diagnosis of mi_ha is before than 1st November 2000, otherwise the value 994 (not applicable) is assigned.
...
* Description: `First diagnosis of mi_ha before the 1st November 2008`

```{r f161, echo=FALSE}
sds <- ubcosG1W6[c("athlosid", "mi_ha_firstdate2008", "mi_ha_firstage2008", "mi_ha2008")]
...
* Name: `mi_ha_firstage2008`
* Table name: `ubcosG1W6`
* Label: `Age of first diagnosis of mi_ha before the 1st November 2008`
* Description: 
...
For the variable `mi_ha`, value 0 is assigned when date of first diagnosis of mi_ha is later than 31st December 2008, the approximate date of the census registry, or never, and value 1 when prior to that date. 
...
For the variable `mi_ha_age`, the same age is assigned when the first diagnosis of mi_ha is before than 31st December 2008, otherwise the value 994 (not applicable) is assigned.
...
```{r f221, echo=FALSE}
sds <- ubcosG2W2[c("athlosid", "mi_ha_firstdate1970", "mi_ha_firstage1970", "mi_ha1970")]
...
```{r f231, echo=FALSE}
sds <- ubcosG2W3[c("athlosid", "mi_ha_firstdate1980", "mi_ha_firstage1980", "mi_ha1980")]
...
```{r f241, echo=FALSE}
sds <- ubcosG2W4[c("athlosid", "mi_ha_firstdate1990", "mi_ha_firstage1990", "mi_ha1990")]
...
```{r f251, echo=FALSE}
sds <- ubcosG2W5[c("athlosid", "mi_ha_firstdate2000", "mi_ha_firstage2000", "mi_ha2000")]
...
```{r f261, echo=FALSE}
sds <- ubcosG2W6[c("athlosid", "mi_ha_firstdate2008", "mi_ha_firstage2008", "mi_ha2008")]
...
```{r vv}
# For 1st generation:
list_df <- list(tibble(id= UBCoS_m_g1_w2$id, hdiab2=UBCoS_m_g1_w2$mi_ha, adiab2=UBCoS_m_g1_w2$mi_ha_age),
                tibble(id= UBCoS_m_g1_w3$id, hdiab3=UBCoS_m_g1_w3$mi_ha, adiab3=UBCoS_m_g1_w3$mi_ha_age), 
                tibble(id= UBCoS_m_g1_w4$id, hdiab4=UBCoS_m_g1_w4$mi_ha, adiab4=UBCoS_m_g1_w4$mi_ha_age),
                tibble(id= UBCoS_m_g1_w5$id, hdiab5=UBCoS_m_g1_w5$mi_ha, adiab5=UBCoS_m_g1_w5$mi_ha_age), 
                tibble(id= UBCoS_m_g1_w6$id, hdiab6=UBCoS_m_g1_w6$mi_ha, adiab6=UBCoS_m_g1_w6$mi_ha_age))
...
# For 2nd generation:**
list_df <- list(tibble(id= UBCoS_m_g2_w2$id, hdiab2=UBCoS_m_g2_w2$mi_ha, adiab2=UBCoS_m_g2_w2$mi_ha_age),
                tibble(id= UBCoS_m_g2_w3$id, hdiab3=UBCoS_m_g2_w3$mi_ha, adiab3=UBCoS_m_g2_w3$mi_ha_age), 
                tibble(id= UBCoS_m_g2_w4$id, hdiab4=UBCoS_m_g2_w4$mi_ha, adiab4=UBCoS_m_g2_w4$mi_ha_age),
                tibble(id= UBCoS_m_g2_w5$id, hdiab5=UBCoS_m_g2_w5$mi_ha, adiab5=UBCoS_m_g2_w5$mi_ha_age), 
                tibble(id= UBCoS_m_g2_w6$id, hdiab6=UBCoS_m_g2_w6$mi_ha, adiab6=UBCoS_m_g2_w6$mi_ha_age))
